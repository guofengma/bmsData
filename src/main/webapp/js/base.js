$(function() {
		...
		$.get("/boss/use", {
			...
			option = {
				...
				series : [ {
					...
					color : [ '#c7353a', '#f5b91e', '#2455d0', '#ff7d4e',
							'#049cfa' ],
					data : function() {
						var serie = [];
	...
	function echart_0() {
		$.get("/boss/loan_month", {
			...
			var geoCoordMap = {
				'东莞二店' : [ 113.766607, 23.015765 ],
				'许昌一店' : [ 113.849239, 34.032331 ],
				'太原一店' : [ 112.574417, 37.831216 ],
				'广州一店' : [ 113.340402, 23.13806 ],
				'平顶山一店' : [ 113.313302, 33.747713 ],
				'立刻贷一店' : [ 113.335657, 23.141947 ],
				'南阳一店' : [ 112.5324, 33.012371 ],
				'郑州一店' : [ 113.687433, 34.791967 ],
				'东莞一店' : [ 113.766554, 23.015358 ],
				'驻马店一店' : [ 114.036952, 33.005157 ],
				'新乡一店' : [ 113.909916, 35.290065 ],
				'信阳一店' : [ 114.081637, 32.128308 ],
				'洛阳一店' : [ 112.435124, 34.674716 ],
				'立刻贷二店' : [ 113.335657, 23.141947 ],
				'总部' : [ 113.335675, 23.141862 ],
				'郑州二店' : [ 113.715354, 34.769138 ],
				'南宁一店' : [ 108.37818, 22.817581 ],
				'东莞三店' : [ 113.766607, 23.015765 ]
			};
	...
	function echart_14() {
		...
		for (var i = 0; i < data.length; i++) {
			var icon = new BMap.Icon('../images/ico.png',
					new BMap.Size(10, 10), {
