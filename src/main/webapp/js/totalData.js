...
// 未结清合同数量 budget
$("#budget").css("width", cWidth-260).css("height", cHeight-200);
...
// 逾期合同数量 fixation
$("#fixation").css("width", cWidth-290).css("height", cHeight-200);
...
// 资金方合同数量 itsum
$("#itsum").css("width", cWidth-250).css("height", cHeight-200);
...
var myChart = echarts.init(dom);
    ...
    //柱子数据
    var data = [98705, 98046, 85310, 79007];
    var option = {
    ...
    series: [
        {
            ...
            type:'line',
            step: 'start',
            data:[90, 99, 169, 154, 188, 120, 189]
        },
       
        {
            ...
            type:'line',
            step: 'end',
            data:[39, 150, 111, 87, 134, 178, 110]
        }
    ],
    color:['#30A5FF', '#FABE28']
};
...
option = {
    ...
    series: [{
        ...
        symbolSize: 8,
        symbol: 'circle',
        data: [290, 200,120, 232, 145, 200, 90]
    }, 
    {
        type: 'pie',
        center: ['83%', '33%'],
