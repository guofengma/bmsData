...
noSettleContract_lineChart = {
		...
		initData:function(div,obj){
			...
			this.option =  {
					...
					noSettleContract_lineChart.interval(lineChartObject);
				...
				invokingAjax:function (lineChartObject,url, data, typeName, startDate, endDate, storeName, title){
					$.post(url, data, function(response){
		 				...
		 				if(response.show_res_code == "0"){
		 					noSettleContract_lineChart.process(lineChartObject,response, startDate, endDate, typeName, storeName, title);
		 				}
...
//					            name:'未结清合同',
			        ...
			        noSettleContract_barChart.process(barChartObject);
				},
...
//					            name:'直接访问',
				...
				uncleared_num_1_3_barChart.process(barChartObject);
				},
				process:function (barChartObject){	
					var storeName = barChartObject.storeName;
					var xAxisData = barChartObject.xAxisData;
...
//					            name:'直接访问',
				...
				uncleared_num_4_6_barChart.process(barChartObject);
				},
				process:function (barChartObject){	
					var storeName = barChartObject.storeName;
					var xAxisData = barChartObject.xAxisData;
...
//					            name:'直接访问',
				...
				uncleared_num_7_12_barChart.process(barChartObject);
				},
				process:function (barChartObject){	
					var storeName = barChartObject.storeName;
					var xAxisData = barChartObject.xAxisData;
...
//					            name:'直接访问',
			...
			uncleared_num_12_barChart.process(barChartObject);
		},
		process:function (barChartObject){	
			var storeName = barChartObject.storeName;
			var xAxisData = barChartObject.xAxisData;
