...
// import com.jyd.common.model.Blog;
//
/// **
...
//
// /**
// * 线程安全的 Service 可以开放一个 static me 变量，方便随处使用 如果要使用业务层 AOP，可以使用如下代码代替 new 创建：
...
// return dao.paginate(pageNumber, pageSize, "select *", "from blog order by id
// asc");
// }
//
