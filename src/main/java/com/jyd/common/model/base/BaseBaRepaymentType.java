...
public abstract class BaseBaRepaymentType<M extends BaseBaRepaymentType<M>> extends Model<M> implements IBean {
	...
	public M setRepaymentType(java.lang.String repaymentType) {
		set("repayment_type", repaymentType);
		return (M)this;
	}
	
	public java.lang.String getRepaymentType() {
		return getStr("repayment_type");
	}
