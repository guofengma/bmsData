...
public abstract class BaseBaDepartmentType<M extends BaseBaDepartmentType<M>> extends Model<M> implements IBean {
	...
	public M setDepartmentType(java.lang.String departmentType) {
		set("department_type", departmentType);
		return (M)this;
	}
	
	public java.lang.String getDepartmentType() {
		return getStr("department_type");
	}
