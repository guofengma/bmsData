...
public abstract class BaseAttOvertimeType<M extends BaseAttOvertimeType<M>> extends Model<M> implements IBean {
	...
	public M setOvertimeType(java.lang.String overtimeType) {
		set("overtime_type", overtimeType);
		return (M)this;
	}
	
	public java.lang.String getOvertimeType() {
		return getStr("overtime_type");
	}
