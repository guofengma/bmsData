...
public abstract class BaseAttOvertime<M extends BaseAttOvertime<M>> extends Model<M> implements IBean {
	...
	public M setOvertimeId(java.lang.Integer overtimeId) {
		set("overtime_id", overtimeId);
		return (M)this;
	}
	
	public java.lang.Integer getOvertimeId() {
		return getInt("overtime_id");
	}
