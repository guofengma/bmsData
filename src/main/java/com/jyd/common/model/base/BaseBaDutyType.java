...
public abstract class BaseBaDutyType<M extends BaseBaDutyType<M>> extends Model<M> implements IBean {
	...
	public M setDutyType(java.lang.String dutyType) {
		set("duty_type", dutyType);
		return (M)this;
	}
	
	public java.lang.String getDutyType() {
		return getStr("duty_type");
	}
