...
public abstract class BaseWfForm<M extends BaseWfForm<M>> extends Model<M> implements IBean {
	...
	public M setClassFullName(java.lang.String classFullName) {
		set("class_full_name", classFullName);
		return (M)this;
	}
	
	public java.lang.String getClassFullName() {
		return getStr("class_full_name");
	}
