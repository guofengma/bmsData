...
public abstract class BaseWfFormEmployeeDutyV1<M extends BaseWfFormEmployeeDutyV1<M>> extends Model<M> implements IBean {
	...
	public M setDutyId(java.lang.Integer dutyId) {
		set("duty_id", dutyId);
		return (M)this;
	}
