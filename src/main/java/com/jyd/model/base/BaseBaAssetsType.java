...
public abstract class BaseBaAssetsType<M extends BaseBaAssetsType<M>> extends Model<M> implements IBean {
	...
	public M setAssetsType(java.lang.String assetsType) {
		set("assets_type", assetsType);
		return (M)this;
	}
	
	public java.lang.String getAssetsType() {
		return getStr("assets_type");
	}
