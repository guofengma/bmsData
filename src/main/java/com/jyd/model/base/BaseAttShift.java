...
public abstract class BaseAttShift<M extends BaseAttShift<M>> extends Model<M> implements IBean {
	...
	public M setShiftType(java.lang.String shiftType) {
		set("shift_type", shiftType);
		return (M)this;
	}
	
	public java.lang.String getShiftType() {
		return getStr("shift_type");
	}
