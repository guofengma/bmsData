...
public abstract class BaseFundContract<M extends BaseFundContract<M>> extends Model<M> implements IBean {
	...
	public M setSupplement(java.lang.Double supplement) {
		set("supplement", supplement);
		return (M)this;
	}
	
	public java.lang.Double getSupplement() {
		return getDouble("supplement");
	}

	public M setReturnThePrincipal(java.lang.Double returnThePrincipal) {
		set("return_the_principal", returnThePrincipal);
		return (M)this;
	}
	
	public java.lang.Double getReturnThePrincipal() {
		return getDouble("return_the_principal");
	}

	public M setReturnInterest(java.lang.Double returnInterest) {
		set("return_interest", returnInterest);
		return (M)this;
	}
	
	public java.lang.Double getReturnInterest() {
		return getDouble("return_interest");
	}

	public M setReturnOfThePrincipal(java.lang.Double returnOfThePrincipal) {
		set("return_of_the_principal", returnOfThePrincipal);
		return (M)this;
	}
	
	public java.lang.Double getReturnOfThePrincipal() {
		return getDouble("return_of_the_principal");
	}

	public M setWaittingOfThePrincipal(java.lang.Double waittingOfThePrincipal) {
		set("waitting_of_the_principal", waittingOfThePrincipal);
		return (M)this;
	}
	
	public java.lang.Double getWaittingOfThePrincipal() {
		return getDouble("waitting_of_the_principal");
	}
	...
	public M setReceiPriceDiff(java.lang.Double receiPriceDiff) {
		set("recei_price_diff", receiPriceDiff);
		return (M)this;
	}
	
	public java.lang.Double getReceiPriceDiff() {
		return getDouble("recei_price_diff");
	}
