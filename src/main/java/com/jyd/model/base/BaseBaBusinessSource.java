...
public abstract class BaseBaBusinessSource<M extends BaseBaBusinessSource<M>> extends Model<M> implements IBean {
	...
	public M setBusinessSource(java.lang.String businessSource) {
		set("business_source", businessSource);
		return (M)this;
	}
	
	public java.lang.String getBusinessSource() {
		return getStr("business_source");
	}
