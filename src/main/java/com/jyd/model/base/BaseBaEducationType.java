...
public abstract class BaseBaEducationType<M extends BaseBaEducationType<M>> extends Model<M> implements IBean {
	...
	public M setEducationType(java.lang.String educationType) {
		set("education_type", educationType);
		return (M)this;
	}
	
	public java.lang.String getEducationType() {
		return getStr("education_type");
	}
