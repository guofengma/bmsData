...
public abstract class BaseTestBatchInsert<M extends BaseTestBatchInsert<M>> extends Model<M> implements IBean {

	public M setCusThirdpartGpsVehicleBaseDataId(java.lang.Integer cusThirdpartGpsVehicleBaseDataId) {
		set("cus_thirdpart_gps_vehicle_base_data_id", cusThirdpartGpsVehicleBaseDataId);
		return (M)this;
	}
	
	public java.lang.Integer getCusThirdpartGpsVehicleBaseDataId() {
		return getInt("cus_thirdpart_gps_vehicle_base_data_id");
	}
